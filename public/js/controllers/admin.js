copenhagenApp.controller('calendarCtrl', ['$scope', '$compile', '$timeout', 'uiCalendarConfig', function($scope, $compile, $timeout, uiCalendarConfig) {
    var date = new Date();
    var d = date.getDate();
    var m = date.getMonth();
...
.controller('roomCtrl', ['$scope', '$rootScope', '$state', 'API', 'FileUploader', 'CSRF_TOKEN', function($scope, $rootScope, $state, API, FileUploader, CSRF_TOKEN) {
    $scope.roomLists = {};
